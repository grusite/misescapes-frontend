<template>
    <div class="bg-gray-500 flex items-center justify-center h-96">
      <div class="relative text-gray-600">
        <input type="search" name="serch" placeholder="Busca por ciudad, sala o escape room" class="bg-white h-12 w-96 px-5 pr-10 rounded-full text-sm focus:outline-none">
